...
```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/tutorial-blitz-alpha
```

Ensure the `.env.test.local` file has required environment variables:

```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/tutorial-blitz-alpha_test
```
